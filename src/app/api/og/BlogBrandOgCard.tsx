export function BlogBrandOgCard() {
    return (
        <div style={{ width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#ff385c', fontFamily: 'Pretendard', color: '#222222' }}>
            <div style={{ width: 1080, height: 600, display: 'flex', flexDirection: 'column', position: 'relative', borderRadius: 28, background: '#ffffff' }}>
                ...
                <div style={{ height: 237, display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#ff385c', fontSize: 78, fontWeight: 800 }}>tikitikit.kr</div>
                <div style={{ position: 'absolute', top: 328, left: 0, width: 32, height: 64, background: '#ff385c', borderRadius: '0 999px 999px 0' }} />
                <div style={{ position: 'absolute', top: 328, right: 0, width: 32, height: 64, background: '#ff385c', borderRadius: '999px 0 0 999px' }} />
            </div>
        </div>
    );
}
