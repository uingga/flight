                                                    ...
                                                    href={
                                                        (flight.source === 'onlinetour')
                                                            ...
                                                            : (flight.source === 'hanatour')
                                                                ? (isMobile
                                                                    ? (flight.mobileFareId
                                                                        ? `https://m.hanatour.com/com/pmt/CHPC0PMT0011M100?searchCond=${encodeURIComponent(JSON.stringify({ fareId: flight.mobileFareId, psngrCntLst: [{ ageDvCd: 'A', psngrCnt: 1 }] }))}`
                                                                        : (flight.searchLink
