...
| Windows `TikitikitNaverCrawl` | 10:00부터 09:53 회차 완료 대기, 완료 감지 즉시 실행 | 전체 여행사 | 280 | 주거용 회선의 유일한 운영 네이버 수집 |
...
`scripts/run-naver-crawl.ps1`은 10:00부터 2분 간격으로 최신 `main`만 확인하다가 09:53 일반
